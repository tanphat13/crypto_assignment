...
sym_key = str(random.randrange(0, 7))
info = sym_key
xor_algo =  xor.new(sym_key)
file_path = '.'
file_name = 'image.png'
raw_file = file_path + '/' + file_name
text = 'NguyenHoangLong-NguyenNgocAnhTuan-CuTanPhat-NguyenHoangLong-NguyenNgocAnhTuan-CuTanPhat-NguyenHoangLong-NguyenNgocAnhTuan-CuTanPhat'
...
print("%d %d %d %d %d" % (number_lines, vstep, hstep, bits_per_line, len(cipher)))
